      ...
      switch (method) {
        ...
        case "profile info":
          return [(0, _expressValidator.body)("profile.description").notEmpty().withMessage("Description field can't be blank!").isLength({
            max: 500
          }).withMessage("Description can't be more that 500 letter.").trim(), (0, _expressValidator.body)("profile.tagline").notEmpty().withMessage("Tagline field can't be blank!").trim(), (0, _expressValidator.body)("profile.nationality").notEmpty().withMessage("Nationality field can't be blank!"), (0, _expressValidator.body)("profile.hourly_rate")["if"](function (value, _ref3) {
            var req = _ref3.req;
          ...
          while (1) {
            switch (_context26.prev = _context26.next) {
              ...
              case 5:
                ...
                _context26.next = 9;
                return userService.updatePassword(id, req.body);
