  ...
  (0, _createClass2["default"])(PostController, [{
    ...
    value: function validator(method) {
      switch (method) {
        case "add post":
        case "edit post":
          return [(0, _expressValidator.sanitizeBody)("title"), (0, _expressValidator.sanitizeBody)("content"), (0, _expressValidator.body)("title").notEmpty().withMessage("Post title can't be empty!").trim(), (0, _expressValidator.body)("content").notEmpty().withMessage("Post content can't be empty!").trim(), (0, _expressValidator.body)("category").notEmpty().withMessage("Job category can't be empty!"), (0, _expressValidator.body)("tags").isArray({
            min: 1,
            max: 10
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = req.query;
                _context.next = 3;
                return postService.readMany(_objectSpread(_objectSpread({}, (query === null || query === void 0 ? void 0 : query.q) && {
                  $or: [{
                    title: {
              ...
              case 6:
                _context.next = 8;
                return postService.getTrendingPostsByViews({
                  limit: 3,
                  days: 30,
                  query: query
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return postService.getSinglePostPageBySlug(slug);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 4;
                return postService.readMany(query, options);
              ...
              case 7:
                ...
                req.flash("info", "Hey! you asked for page ".concat(req.query.page || 1, ". But that dosen't exist. So i put you on page ").concat(postsReadResponse.pages, "."));
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 6:
                _context5.next = 8;
                return postService.readOne(_objectSpread({
                  slug: slug
                }, req.user.role !== "admin" && {
                  created_by: req.user._id
                }));
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 35:
                ...
                _context9.next = 40;
                return postService.updateOne(_objectSpread({
                  slug: slug
                }, req.user.role !== "admin" && {
