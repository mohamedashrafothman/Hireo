...
var MessageController = /*#__PURE__*/function (_Controller) {
  ...
  (0, _createClass2["default"])(MessageController, [{
    ...
    value: function validator(method) {
      switch (method) {
        case "add message":
          return [(0, _expressValidator.sanitizeBody)("content"), (0, _expressValidator.body)("content").notEmpty().withMessage("Message Can't be Empty!").trim()];
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 12:
                ...
                _context.next = 16;
                return messageService.create(req.body);
