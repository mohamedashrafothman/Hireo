  ...
  (0, _createClass2["default"])(CommentController, [{
    ...
    value: function validator(method) {
      switch (method) {
        case "add comment":
        case "edit comment":
          return [(0, _expressValidator.sanitizeBody)("content"), (0, _expressValidator.body)("content").notEmpty().withMessage("Comment's content can't be empty!").isLength({
            max: 500
          }).withMessage("Comment's content exceeds the limit of 500 letter!").trim()];
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                _context.next = 9;
                return commentService.create(_objectSpread(_objectSpread({}, req.body), {}, {
              ...
              case 17:
                _context.next = 19;
                return commentService.updateOne({
