...
var SkillController = /*#__PURE__*/function (_Controller) {
  ...
  function SkillController(service) {
    ...
    _this.getSkillsList = _this.getSkillsList.bind((0, _assertThisInitialized2["default"])(_this));
    _this.getEditSkills = _this.getEditSkills.bind((0, _assertThisInitialized2["default"])(_this));
    _this.addSkill = _this.addSkill.bind((0, _assertThisInitialized2["default"])(_this));
    _this.editSkill = _this.editSkill.bind((0, _assertThisInitialized2["default"])(_this));
    _this.deleteSkills = _this.deleteSkills.bind((0, _assertThisInitialized2["default"])(_this));
    return _this;
  }
  ...
  (0, _createClass2["default"])(SkillController, [{
    ...
    value: function validator(method) {
      switch (method) {
        case "add skill":
        case "edit skill":
          return [(0, _expressValidator.body)("name.en").notEmpty().withMessage("Skill english name can't be empty!").trim().escape(), (0, _expressValidator.body)("name.ar").notEmpty().withMessage("Skill arabic name can't be empty!").trim().escape(), (0, _expressValidator.body)("description.en").notEmpty().withMessage("Skill english description can't be empty!").trim().escape(), (0, _expressValidator.body)("description.ar").notEmpty().withMessage("Skill arabic description can't be empty!").trim().escape()];
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                req.flash("info", "Hey! you asked for page ".concat(req.query.page || 1, ". But that doesn't exist. So i put you on page ").concat(skillsListResponse.pages, "."));
        ...
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                skillDeletionResponse = _context6.sent;
...
var _default = new SkillController(skillService);
