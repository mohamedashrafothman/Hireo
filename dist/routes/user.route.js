...
router.route("/login").get(_User["default"].getLogin).post(_User["default"].validator("login"), _User["default"].loginUser);
router.route("/register").get(_User["default"].isLoggedIn, _User["default"].getRegisteration).post(_User["default"].validator("register"), _User["default"].registerUser);
