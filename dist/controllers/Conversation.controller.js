          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                conversationQuery = _objectSpread({}, id && {
                  _id: id
                }, {}, req.user.role !== "admin" && {
                  users: req.user._id
                }, {}, !id && {
                ...
                conversationsQuery = _objectSpread({}, req.user.role !== "admin" && {
                  users: req.user._id
                }, {
                  is_deleted: false,
                  deleted_by: {
              ...
              case 14:
                res.render("dashboard/messages", _objectSpread({
                  page_title: "Messages"
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 9:
                _context2.next = 11;
                return conversationService.updateOne(query, _objectSpread({}, conversationReadResponse.data.deleted_by.length >= 1 && {
                  $set: {
                    is_deleted: true
                  }
