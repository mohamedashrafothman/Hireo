    ...
    value: function validator(method) {
      switch (method) {
        ...
        case "edit application":
          return [(0, _expressValidator.sanitizeBody)("name"), (0, _expressValidator.body)("name").notEmpty().withMessage("Name can't be empty!").trim().escape(), (0, _expressValidator.body)("email").notEmpty().withMessage("Email must supply an E-mail.").isEmail().withMessage("Email must be in an E-mail format.").trim()];
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                res.render("dashboard/applications/list", _objectSpread({
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return applicationService.isAppliedBefore(req.params.id, req.user._id);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 22:
                ...
                _context5.next = 25;
                return applicationService.create(req.body);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 3;
                return applicationService.updateOne({
                  _id: application,
                  job: job
                }, {
                  $set: {
