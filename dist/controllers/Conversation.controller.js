...
var ConversationController = /*#__PURE__*/function (_Controller) {
  ...
  function ConversationController(service) {
    ...
    _this.getAllConversations = _this.getAllConversations.bind((0, _assertThisInitialized2["default"])(_this));
    _this.deleteConversation = _this.deleteConversation.bind((0, _assertThisInitialized2["default"])(_this));
    return _this;
  }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return this.service.readMany(conversationQuery, options);
              ...
              case 9:
                _context.next = 11;
                return this.service.readMany(conversationsQuery, options);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return this.service.readOne(query);
              ...
              case 9:
                _context2.next = 11;
                return this.service.updateOne(query, _objectSpread(_objectSpread({}, conversationReadResponse.data.deleted_by.length >= 1 && {
                  $set: {
                    is_deleted: true
                  }
