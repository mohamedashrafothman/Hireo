  ...
  (0, _createClass2["default"])(CategoryController, [{
    ...
    value: function validator(method) {
      switch (method) {
        ...
        case "edit category":
          ...
          }).notEmpty().withMessage("For parent categories you must add an icon."), (0, _expressValidator.sanitizeBody)("name.en"), (0, _expressValidator.sanitizeBody)("name.ar"), (0, _expressValidator.sanitizeBody)("description.en"), (0, _expressValidator.sanitizeBody)("description.ar")];
    ...
    value: function () {
      var _getEditCategory = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res, next) {
        var slug, categoryReadResponse, categoriesReadResponse, iconsReadResponse;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return categoryService.getEditCategoryData(slug);
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 35:
                if (req.body.parent) delete req.body.parent;
                _context7.next = 38;
                return categoryService.editCategory(req.params.slug, req.body);
    ...
    value: function () {
      var _deleteCategory = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(req, res, next) {
        var id, categoryDeletionResponse, categoryAttachmentDeleteIds, categoryAttachmentDeleteRespose, categoryAttachmentDeleteFilesResponse;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 6:
                ...
                categoryAttachmentDeleteIds = categoryDeletionResponse.data.filter(function (attach) {
                ...
                return attachmentService.deleteMany({
                  _id: {
                    $in: categoryAttachmentDeleteIds
                  }
                }, {
                  pagination: false
                });
              ...
              case 10:
                categoryAttachmentDeleteRespose = _context8.sent;

                if (!categoryAttachmentDeleteRespose.error) {
                  _context8.next = 13;
                  break;
                }

                return _context8.abrupt("return", next(categoryAttachmentDeleteRespose.errors));

              case 13:
                _context8.next = 15;
                return attachmentService.handelFilesForDirDeletion(categoryAttachmentDeleteRespose.data.map(function (attach) {
                  return attach.path;
                }));

              case 15:
                categoryAttachmentDeleteFilesResponse = _context8.sent;

                if (!categoryAttachmentDeleteFilesResponse.error) {
                  _context8.next = 18;
                  break;
                }

                return _context8.abrupt("return", next(categoryAttachmentDeleteFilesResponse.errors));
