...
$(document).ready(function() {
	if (document.getElementById("map") !== null) {
		...
		// ----------------------------------------------- //
		var locations = [
			[locationData("single-job-page.html", "images/company-logo-01.png", "Hexagon", "Bilingual Event Support Specialist", "verified"), 37.788181, -122.46127, 5, ""],
			...
			[locationData("single-job-page.html", "images/company-logo-06.png", "Trideo", "International Marketing Specialist", "not-verified"), 37.73281, -122.415951, 9, ""],
	...
	function singleListingMap() {
		...
		var hireoIcon = L.divIcon({
			...
			className: "hireo-marker-icon",
			html:
				'<div class="marker-container no-marker-icon ">' +
				'<div class="marker-card">' +
				'<div class="front face">' +
				singleMapIco +
				"</div>" +
