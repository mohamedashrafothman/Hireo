  ...
  (0, _createClass2["default"])(JobController, [{
    ...
    value: function validator(method) {
      switch (method) {
        case "add job":
        case "edit job":
          return [(0, _expressValidator.sanitizeBody)("title"), (0, _expressValidator.sanitizeBody)("location.address"), (0, _expressValidator.sanitizeBody)("description"), (0, _expressValidator.body)("title").notEmpty().withMessage("Job title can't be empty!"), (0, _expressValidator.body)("type").notEmpty().withMessage("Job type can't be empty!"), (0, _expressValidator.body)("category").notEmpty().withMessage("Job category can't be empty!"), (0, _expressValidator.body)("location.address").notEmpty().withMessage("Job location can't be empty!"), (0, _expressValidator.body)("salary.min").notEmpty().withMessage("Job minimum salary can't be empty!"), (0, _expressValidator.body)("salary.max").notEmpty().withMessage("Job maximum salary can't be empty!").custom(function (value, _ref) {
            var req = _ref.req;
            return Number(value) > Number(req.body["salary.min"]);
          }).withMessage("Salary maxmum value can't be less than minimum value."), (0, _expressValidator.body)("tags").optional().isArray({
            min: 1,
            max: 10
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return jobService.readMany(query, options);
              ...
              case 10:
                res.render("dashboard/jobs/list", _objectSpread({
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 31:
                ...
                _context5.next = 34;
                return jobService.create(req.body);
        ...
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 10:
                _context6.next = 12;
                return jobService.readOne(_objectSpread({
    ...
    value: function () {
      var _editJob = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(req, res, next) {
        var errors, err, categoriesListResponse, jobTypeListResponse, jobResponse, savedAttachments, port, base, files, i, fileCreationResponse, jobUpdateResponse, categoryUpdatedResponse, userUpdateResponse;
        return _regenerator["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 21:
                return _context7.abrupt("return", res.render("dashboard/jobs/add", {
                  page_title: "Edit a Job",
                  data: {
                    job: jobResponse,
                    jobTypes: jobTypeListResponse.data,
              ...
              case 38:
                ...
                _context7.next = 41;
                return jobService.updateOne(_objectSpread({
                  slug: req.params.slug
                }, req.user.role !== "admin" && {
                  created_by: req.user._id
                }), {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 25:
                ...
                if (!(attachmentDeleteResponse.statusCode === 404)) {
                  _context8.next = 29;
                  break;
                }
        ...
        return _regenerator["default"].wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 23:
                res.render("dashboard/jobs/candidates", _objectSpread({
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 2:
                ...
                return _context11.abrupt("return", next(categoryReadResponse.erros));
              ...
              case 30:
                res.render("jobs-list", _objectSpread({
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                _context12.next = 4;
                return jobService.getBySlug(req.params.slug, req.user);
